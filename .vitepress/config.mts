    ...
    sidebar: [
      {
        items: [
          ...
          },
          {
            text: 'DeathInsurance', link: '/DeathInsurance/Readme.md', collapsed: true, items: [
              ...
              { text: 'Types', collapsed: true, items: [
                { text: 'types', link: '/DeathInsurance/Types/types.xml' },
              ]}
            ]
          },
          {
            text: 'GlobalConfigs', link: '/GlobalConfigs/Readme.md', collapsed: true, items: [
              { text: 'Configs', collapsed: true, items: [
                { text: 'AdminConfig', link: '/GlobalConfigs/Configs/ConfigSchema/AdminConfig.json' },
                { text: 'CurrencyConfig', link: '/GlobalConfigs/Configs/ConfigSchema/CurrencyConfig.json' },
                { text: 'Logger', link: '/GlobalConfigs/Configs/ConfigSchema/Logger.json' },
                { text: 'TBKeyBindsConfig', link: '/GlobalConfigs/Configs/ConfigSchema/TBKeyBindsConfig.json' },
                { text: 'TBKeyCodeMatch', link: '/GlobalConfigs/Configs/ConfigSchema/TBKeyCodeMatch.json' },
              ]}
            ]
          },
          {
          ...
          {
            text: 'The Mod Base Shop', link: '/The Mod Base/README.md', collapsed: true, items: [
