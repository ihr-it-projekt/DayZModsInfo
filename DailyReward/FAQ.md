...
- Copy the files from `TBDailyReward` into `YourServerProfilesFolder\TBMods\Config\TBDailyReward` folder
- Start your server. Some more configurations will be generated.
- Tear down the server
- Configure your needs
- Start your server :-)

## How can I reset a single player?
- write down the player id (Bohemia ID)
- kill the player in game
- player must logout
- wait for player data store to not lose data from other players, see changed timestamp of files. Player Data will be stored when DayZ saves the PlayerBase.
...
- reload the data with "Reload Player Data" in the menu

## How can I reset all players?
- stop your server
- delete the folder `YourServerProfilesFolder\TBMods\Data\TBDailyReward`

## How can I give player premium status?

see also [**`Global FAQ Premium API`**](../GlobalConfigs/Readme.md)

There are 3 items implemented. Just give them one of the items and they will get premium status for Daily Reward.
